...
function setCookie(){
  ...
  // 만료일 생성
  // let expiration = nowDate.getDate() + 10; // 오늘날짜 +10
  // console.log(expiration); // 오늘날짜

  // 현재날짜 --> +10일로 날짜가 나타나도록 생성 --> setDate()메서드 사용
...
// {!} Summary
// --1. JS에서 쿠키를 편리하게 쓰려면 사용자가 직접 함수를 만들어서 쓰는게 편리하가
// --2. 더 편리한건 JS의 쿠키 관련 경량 라이브러리를 쓰는게 더 편리하다
// --3. document.cookie 가 열일하는구나
